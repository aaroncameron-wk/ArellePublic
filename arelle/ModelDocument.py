...
from arelle.inline.ixds import IxdsLoader
...
def load(modelXbrl, uri, base=None, referringElement=None, isEntry=False, isDiscovered=False, isIncluded=None, isSupplemental=False, namespace=None, reloadCache=False, **kwargs) -> ModelDocument | None:
    ...
    try:
        pullLoaders = [
            IxdsLoader.inlineXbrlDocumentSetLoader,
        ] + list(pluginClassMethods("ModelDocument.PullLoader"))
    ...
    if rootNode is not None:
        ...
        if ns == XbrlConst.xsd and ln == "schema":
            ...
            identifiers = [
                IxdsLoader.identifyInlineXbrlDocumentSet
            ] + list(pluginClassMethods("ModelDocument.IdentifyType"))
        ...
        # discovery (parsing)
        discoverers = [
            IxdsLoader.discoverInlineXbrlDocumentSet
        ] + list(pluginClassMethods("ModelDocument.Discover"))
        ...
        if isEntry:
            ...
            if hasattr(modelXbrl, "ixdsHtmlElements"):
                IxdsLoader.ixdsDiscover(modelXbrl, modelDocument) # compile cross-document IXDS references
