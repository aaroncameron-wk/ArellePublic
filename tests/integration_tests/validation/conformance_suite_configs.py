...
from tests.integration_tests.validation.conformance_suite_configurations.xbrl_utr_malformed_1_0 import generate_configs as generate_xbrl_utr_malformed_1_0
...
ALL_CONFORMANCE_SUITE_CONFIGS: list[ConformanceSuiteConfig] = [
    efm_current,
    esef_ixbrl_2021,
    esef_xhtml_2021,
    xbrl_2_1,
    ...
    *generate_xbrl_utr_malformed_1_0(),
    xbrl_utr_registry_1_0,
    xbrl_utr_structure_1_0,
]

PUBLIC_CONFORMANCE_SUITE_CONFIGS = [c for c in ALL_CONFORMANCE_SUITE_CONFIGS if c.public_download_url]
